...
bot = telebot.TeleBot('5865486665:AAHinkoBVE2tt8hoNQc2Ii-AVglFdNrDAVc')
...
def update():
with open('/content/drive/MyDrive/dialogues.txt', encoding='utf-8') as f:
content = f.read()
...
return 'Я не нашёл информации об этом'
...
doc = requests.get('https://api.telegram.org/file/bot{0}/{1}'.format('5865486665:AAHinkoBVE2tt8hoNQc2Ii-AVglFdNrDAVc', file_info.file_path))
